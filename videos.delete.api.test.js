...
describe('API de Vídeos - Exclusão (/api/admin/videos)', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  it('deve excluir um vídeo existente com sucesso', async () => {
    const videoId = 1;
    ...
    // Mock do retorno da biblioteca (vídeo excluído)
    videosLib.deleteVideo.mockResolvedValue({ id: videoId });
