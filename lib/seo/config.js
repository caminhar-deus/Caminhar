...
/**
 * Sanitiza um objeto para uso em JSON-LD, prevenindo injeção XSS
 * ao escapar caracteres que poderiam quebrar o script tag.
 * 
 * @param {Object} schema - Objeto do schema.org
 * @returns {string} JSON stringified e sanitizado
 */
export function sanitizeJsonLd(schema) {
