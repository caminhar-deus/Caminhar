 ...
 * Otimizado: usa json_object_agg para agregar diretamente no PostgreSQL,
 * eliminando a necessidade de loop em JavaScript.
...
export async function getSettings() {
  ...
  // Retorna o objeto diretamente do PostgreSQL (json_object_agg)
  // ou objeto vazio se não houver configurações
...
/**
 * Alias para getAllSettingsRaw — mantido para compatibilidade com consumidores existentes.
 * @returns {Promise<Array>} Lista de todos os registros de configuração.
 */
export const getAllSettings = getAllSettingsRaw;
