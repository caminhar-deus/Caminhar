...
import { getAuthToken, verifyToken } from '../auth/auth.js';
import { checkRateLimit, getCacheMetrics } from '../cache/cache.js';
 ...
 * Utiliza `checkRateLimit` de `lib/cache/cache.js` que tem suporte a Redis + fallback em memória.
