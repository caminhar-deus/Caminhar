...
import { getAuthToken, verifyToken, hashPassword } from '../../../../lib/auth/auth.js';
...
describe('API Admin - Gestão de Usuários (/api/admin/users)', () => {
  ...
  it('deve retornar 500 se o banco de dados cair abruptamente', async () => {
    ...
    // Remove o mockImplementation padrão e força rejeição em todas as chamadas de query
    query.mockReset();
    query.mockRejectedValue(new Error('Erro catastrófico do DB'));
