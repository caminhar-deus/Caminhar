...
/**
 * Migration 012: Adiciona índices de performance
 *
 * Problema identificado:
 * - Consultas com LIKE %termo% em LOWER(title) e LOWER(content) causam full table scan
 ...
 *
 * Nota: originalmente em formato .sql; convertida para .js para que o
 * runner (scripts/migrate.js) a execute e a inclua no status.
 */
