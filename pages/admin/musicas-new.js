...
export default function AdminMusicasNewPage() {
  ...
  if (!isAuthenticated) {
    return (
      <div className={styles.container}>
        <Head>
          <title>Admin - Músicas (Novo) - O Caminhar com Deus</title>
        </Head>

        <main className={styles.main}>
          <div className={styles.loginContainer}>
            <h1>Gestão de Músicas (Novo Sistema)</h1>
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Admin - Músicas (Novo Sistema) - O Caminhar com Deus</title>
      </Head>
